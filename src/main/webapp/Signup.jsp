					...
					<form action="User_Register" method="post">
								...
								<div class="form-group ">
									<label for="exampleInputName">Enter Name </label> <input
										...
										aria-describedby="NameHelp" placeholder="Enter Name" name="uname">
									
								</div>
								<div class="form-group">
									<label for="exampleInputQulification1">Enter Qualification</label> <input
										type="=text" class="form-control"
										id="exampleInputQulification11" placeholder="Qilification" name="uquli" >
								</div>
								...
								<button type="submit" class="btn btn-primary bodge-pill btn-block">SignUp</button>
