	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="Add_Jobs.jsp"><i
					class="fa-solid fa-circle-plus"></i>post job</a>
			<li class="nav-item"><a class="nav-link" href="View_Jobs.jsp"><i
					class="fa-solid fa-eye"></i>view job</a>
		...
		<c:if test="${userobj.role eq 'admin' }">
			...
			class="fa-solid fa-user-lock "></i>LogOut</a>
        			...
        			<table class="table">
        				<tbody>
        					...
        					<tr>
        						...
        						<th scope="row">Qulification</th>
        						<th>${userobj.qulification }</th>
        					</tr>
